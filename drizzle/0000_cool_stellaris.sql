...
CREATE TABLE IF NOT EXISTS "user_subscription" (
	...
	"transaction_id" text,
	CONSTRAINT "user_subscription_order_id_unique" UNIQUE("order_id")
);
--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "unit_materials" ADD CONSTRAINT "unit_materials_unit_id_units_id_fk" FOREIGN KEY ("unit_id") REFERENCES "units"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
